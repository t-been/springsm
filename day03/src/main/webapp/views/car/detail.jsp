    ...
    <div class="col-sm-5">
      <form id="detail_form">
        ...
        <div class="form-group">
          ...
          <input type="text" readonly value="${car.carModel}" class="form-control" placeholder="Enter Model" id="model" name="carModel">
        </div>
        <div class="form-group">
          <label for="price">Price:</label>
          <input type="text" value="${car.carPrice}" class="form-control" placeholder="Enter Price" id="price" name="carPrice">
        </div>
        <div class="form-group">
          <label for="price">ImgName:</label>
          <input type="text" value="${car.imgName}" class="form-control" placeholder="Enter Imgname" id="img" name="imgName">
        </div>
        <div class="form-group">
          <label for="regdate">RegDate:</label>
          <input type="text" readonly value="${car.carRegDate}" class="form-control" placeholder="Enter RegDate" id="regdate" name="regDate">
        </div>

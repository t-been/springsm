    ...
    <div class = "col-sm-5">
      <form id = "register_form">
        ...
        <div class="form-group">
          ...
          <input type="password" value="${car.custPwd}" class="form-control" placeholder="Enter Password" id="model" name = 'carModel'>
        </div>
        <div class="form-group">
          <label for="name">Name:</label>
          <input type="text" value="${car.custName}" class="form-control" placeholder="Enter Name" id="name" name = 'custName'>
        </div>
